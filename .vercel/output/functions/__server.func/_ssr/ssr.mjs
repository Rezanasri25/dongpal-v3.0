...
import { A as resolveManifestCssLink, B as rootRouteId, D as getScriptPreloadAttrs, H as require_react, I as isDangerousProtocol, M as executeRewriteInput, O as getStylesheetHref, R as isRedirect, S as require_jsx_runtime, V as isNotFound, a as isSsrResponse, c as stripSsrResponseBody, i as disposeSsrResponseDetached, j as _getRenderedMatches, k as resolveManifestAssetLink, n as bindSsrResponseToRequest, o as normalizeSsrResponse, p as RouterProvider, r as defineHandlerCallback, s as replaceSsrResponse, t as renderRouterToStream, z as parseRedirect } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DvU7sSpl.mjs");
...
var manifest = { "fcec610c2504bb1f8ffac937c32fa6d3f102d046a73ae3fed34c95260613cb39": {
	functionName: "parseReceipt_createServerFn_handler",
	importer: () => import("./parse-receipt-iVeE4vi4.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D3IZdQAo.mjs").then((n) => n.t),
